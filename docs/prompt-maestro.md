...
## Contexto
- MedTopix es un **prototipo académico clínico** (Máster Salud Digital e IA, OBS Business School, Grupo 5): seguimiento de adherencia a tratamientos farmacológicos y nutricionales con tres roles (profesional de la salud, paciente, farmaceuta) sobre un mismo caso.
